...
require_cluster() {
    # The kubeconfig is the whole contract: deploy_k0rdent.sh writes it, and a
...
Run KCM=<version> ./scripts/deploy_k0rdent.sh, or put the kubeconfig of your
own k0rdent cluster there."
